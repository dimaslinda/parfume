...
<body class="flex justify-center items-center h-screen bg-gray-100">
    <div class="p-10 mx-auto max-w-md text-center bg-white rounded-lg shadow-md">
        <h1 class="mb-4 text-4xl font-bold text-gray-900">429</h1>
        <p class="mb-6 text-lg text-gray-600">Maaf, kamu telah mengirim terlalu banyak permintaan dalam waktu singkat. Silakan coba lagi nanti.</p>
